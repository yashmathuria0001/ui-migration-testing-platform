...
function Dashboard() {
  ...
  const handlePaymentSubmit = () => {
    // BUG: Late fee validation removed during migration
  ...
  const handleSendMessage = () => {
    // BUG: Form validation removed during migration
      ...
      <div className="section-view">
        ...
        <div className="statements-container">
          <div className="statements-header">
            <p>View you're monthly loan payment statement's</p>
          </div>
          ...
          <div className="statements-table">
            <div className="table-header">
              ...
              <div className="col">Principle Paid</div>
              <div className="col">Interest Payed</div>
